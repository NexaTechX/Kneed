    ...
    <SafeView style={styles.root}>
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          <Text style={styles.kicker}>KNEAD PRIVACY</Text>
          <Text style={styles.title}>Your data, respected.</Text>
          <Text style={styles.subtitle}>
            This page outlines what data is collected, why it is used, and how you stay in control of your privacy.
          </Text>
        </View>
        ...
        <View style={styles.sectionCard}>
          <Text style={styles.sectionTitle}>3. Third-party processors</Text>
          <Text style={styles.p}>
            We work with trusted partners such as Supabase, Paystack, and Expo services. Production policy should list
            all subprocessors, retention windows, and applicable user rights by region.
          </Text>
        </View>

        <View style={styles.sectionCard}>
          <Text style={styles.sectionTitle}>4. Sensitive information</Text>
          <Text style={styles.p}>
            Avoid uploading sensitive health information unless your compliance and legal teams explicitly approve the
            product flow and storage controls.
          </Text>
        </View>
        ...
        <View style={styles.ctaRow}>
          <Link href="/(auth)/terms" asChild>
            <Pressable style={styles.secondaryBtn}>
              <Text style={styles.secondaryBtnText}>Read Terms</Text>
            </Pressable>
          </Link>
